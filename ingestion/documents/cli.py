...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("command", choices=("probe", "sync", "sync-url", "sync-many", "sync-all"))
    ...
    if args.command == "sync-url" and not args.url:
        parser.error("sync-url requires --url")
